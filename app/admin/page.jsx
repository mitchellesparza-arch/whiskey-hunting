        ...
        {tab === 'tools' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
            {[
              ...
              {
                key:    'backfillPrices',
                label:  '2. Backfill Prices',
                desc:   'Writes cached market prices + MSRP into canonical bottle records. Run after Seed.',
                url:    '/api/admin/backfill-prices',
                method: 'POST',
              },
              {
                key:    'market',
                label:  '3. Market Price Refresh',
