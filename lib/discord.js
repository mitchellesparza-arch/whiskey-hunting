...
/**
 * postJonFind — posts a user-reported find to Jon's Discord as a forum
 * thread post. Same model as postBoBFind (which proved out well), just a
 * single webhook/channel instead of BOB's Chicago/suburbs split.
 * Uses JON_FINDS_WEBHOOK, replacing the old plain-embed DISCORD_FINDS_WEBHOOK post.
 *
