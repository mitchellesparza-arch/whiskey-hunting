...
function scoreMatch(norm, candidate) {
  // Brand + numeric gate: the candidate must share the query's distinctive brand
  // token and all of its age/year/proof numbers. Prevents both "22 Year" →
  // "7 Year" (numbers) and "Old Forester 1920" → "Old Fitzgerald 1920" (brand).
  if (!sameBottleLine(norm, candidate)) return 0
