  ...
  const results = await Promise.all(
    canaryBottles.map(async (bottle) => {
      ...
      for (const code of storeCodes) {
        ...
        // purchaseAvailability is an integer unit count (confirmed from live Algolia data).
        const quantity = typeof entry?.purchaseAvailability === 'number' ? entry.purchaseAvailability : null
